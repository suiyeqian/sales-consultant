  ...
  canActivate() {
    ...
    if (r) {
      ...
      if (localStorage.getItem('bdss_accessToken')) {
        ...
        // 'KJDd5yBWc1wNaH1M3Jt7WrZTBjARgeGco3LAoav4vO6CV3rb0FZ2jX4Ej37r3tKpMUbcdqVNLOXvSUWVHUzt');
        // localStorage.setItem('bdss_weiXinDeviceId', '0f035a8947245cf2501f8a78d40ee314');
